...
// Tighter-cap variant of fairValueArb. Clamps fair_YES into [0.40, 0.60].
//
// Hypothesis: the [0.35, 0.65] cap alone may not produce enough divergence to
// suppress the bad high-edge NO trades observed in the base arm. A narrower
// band forces more clamping events, accelerating sample collection AND
// providing a third arm to compare against base + medium cap.
//
// All other parameters identical to fairValueArbCapped.
...
export const fairValueArbCappedTight: Strategy = {
  name: "fairValueArbCappedTight",
